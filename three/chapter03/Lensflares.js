...
class Lensflares extends React.Component {
    componentDidMount() {
    ...
    init = targetNode => {
        // 初始化基础对象
        const renderer = initRenderer(targetNode, { alpha: true });// 绑定dom并返回renderer
        ...
        const textureFlare0 = THREE.TextureLoader(lensflare0);
        const textureFlare3 = THREE.TextureLoader(lensflare3);
