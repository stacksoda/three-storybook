...
Stats.Panel = function (name, fg, bg) {
    ...
    cavas.width = WIDTH;
    cavas.height = HEIGHT;
    cavas.style.cssText = 'width:80px;height:48px';
    ...
    return {
        ...
        update: function (value, maxValue) {
            ...
            context.drawImage(cavas, GRAPH_X + PR, GRAPH_Y, GRAPH_WIDTH - PR, GRAPH_HEIGHT, GRAPH_X, GRAPH_Y, GRAPH_WIDTH - PR, GRAPH_HEIGHT);
